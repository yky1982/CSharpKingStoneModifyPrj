...
{
    public partial class SelectHistoryData_No2 : Form
    {
        private CreateTestResult_No2 m_ParentHandle;
        private Bench_2 m_BenchHandle;
        public SelectHistoryData_No2(CreateTestResult_No2 handle, Bench_2 benchHandle)
        {
            InitializeComponent();
        ...
        private void SelectHistoryData_No2_Load(object sender, EventArgs e)
        {
