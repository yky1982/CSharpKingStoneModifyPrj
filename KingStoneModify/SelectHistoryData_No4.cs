...
{
    public partial class SelectHistoryData_No4 : Form
    {
        private CreateTestResult_No4 m_ParentHandle;
        private Bench_4 m_BenchHandle;
        public SelectHistoryData_No4(CreateTestResult_No4 handle, Bench_4 benchHandle)
        {
            InitializeComponent();
        ...
        private void SelectHistoryData_No4_Load(object sender, EventArgs e)
        {
