...
{
    public partial class Bench_1 : Form
    {
        #region INI
        [DllImport("kernel32")]
        ...
        private TestResultShow_No1 m_TestResultHandle;
        private CreateTestResult_No1 m_CreateTestResult_No1Handle;
        ...
        public Bench_1(Form1 Handle, GroupBox grp)
        {
            InitializeComponent();
        ...
        public string m_DataBaseFilePath = Application.StartupPath + "\\1#\\DataBase.mdb";
        ...
        private void Bench_1_Load(object sender, EventArgs e)
        {
            m_SettingFormHandle = new SettingForm_No1(m_MainFrameHandle, this);
        ...
        private void SampleDataFun(object o, ElapsedEventArgs e)
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("PressureTest_Bench1", ref TestData, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressureTime_Bench1", ref KeepPressureTime, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("DropPressure_Bench1", ref DropPressure, ref dt);
            if (code != 1)
            {
                return;
            }
        ...
        private void SampleSystemStatusFun(object o, ElapsedEventArgs e)
        {
            ...
            DateTime dt = DateTime.Now;
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusManual_No1_Bench1", ref SystemStatusManual, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusEmergencyStop_No1_Bench1", ref SystemStatusEmergencyStop, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusStop_No1_Bench1", ref SystemStatusStop, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusAddPressure_No1_Bench1", ref SystemStatusAddPressure, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusKeepPressure_No1_Bench1", ref SystemStatusKeepPressure, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusDropPressure_No1_Bench1", ref SystemStatusDropPressure, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("PressureTest_Bench1", ref PressureTest, ref dt);
            if (code != 1)
            {
                return;
            }
        ...
        private void SampleStartFun(object o, ElapsedEventArgs e)
        {
            ...
            DateTime dt = DateTime.Now;
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("ReadStartTest_Bench1", ref startFlag, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            startFlag = false;
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ReadStartTest_Bench1", startFlag);
        }
        ...
        private void SampleStopFun(object o, ElapsedEventArgs e)
        {
            ...
            bool stopFlag = false;
            DateTime dt = DateTime.Now;
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("ReadStopTest_Bench1", ref stopFlag, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ReadStopTest_Bench1", stopFlag1);
        ...
        private void BT_Start_Click(object sender, EventArgs e)
        {
            ...
            m_SampleDataTimer.Start();
            int code = m_MainFrameHandle.m_PLCCommHandle.WriteData("StartTest_Bench1", StartSignal);
            if (code != 1)
            {
        ...
        private void BT_Stop_Click(object sender, EventArgs e)
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.WriteData("StopTest_Bench1", StopSignal);
            if (code != 1)
            {
        ...
        public void CreatResultForm()
        {
            ...
            m_TestResultHandle = new TestResultShow_No1(this, m_MainFrameHandle);
        ...
        {
            m_CreateTestResult_No1Handle = new CreateTestResult_No1(this);
        ...
        private void ReadSettingData()
        {
            ...
            m_MainFrameHandle.m_PLCCommHandle.ReadData("ChanelSelect_No1_Bench1", ref ChanelSelect_No1, ref dt);

            bool ChanelSelect_No2 = false;
            m_MainFrameHandle.m_PLCCommHandle.ReadData("ChanelSelect_No2_Bench1", ref ChanelSelect_No2, ref dt);

            bool ChanelSelect_No3 = false;
            m_MainFrameHandle.m_PLCCommHandle.ReadData("ChanelSelect_No3_Bench1", ref ChanelSelect_No3, ref dt);

            float ContinueTime = 0.0f;
            if (ChanelSelect_No3)
            {
                float time3 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No3_Bench1", ref time3, ref dt);
                ContinueTime += time3;

                float Press3 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No3_Bench1", ref Press3, ref dt);
                ...
                WritePrivateProfileString(strSec, "KeepSelect_No3_Bench1", "ON", strFilePath);
            }

            if (ChanelSelect_No2)
            {
                float time2 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No2_Bench1", ref time2, ref dt);
                ContinueTime += time2;

                float Press2 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No2_Bench1", ref Press2, ref dt);
                ...
                WritePrivateProfileString(strSec, "KeepSelect_No2_Bench1", "ON", strFilePath);
            }

            if (ChanelSelect_No1)
            {
                float time1 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No1_Bench1", ref time1, ref dt);
                ContinueTime += time1;

                float Press1 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No1_Bench1", ref Press1, ref dt);
