...
{
    public partial class SettingForm_No2 : Form
    {
        [DllImport("kernel32")]
        ...
        private Bench_2 m_ParentFormHandle;
        private BaseSetting_No2 m_BaseSettingHandle;
        private string strFilePath = Application.StartupPath + @"\2#\TestConfig.ini";//获取INI文件路径
        private string strSec = "TestConfig"; //INI文件名
        public SettingForm_No2(Form1 Handle, Bench_2 ParentForHandle)
        {
            InitializeComponent();
        ...
        private void SettingForm_No2_Load(object sender, EventArgs e)
        {
            Load_INI();
        ...
        private void Load_INI()
        {
            if (File.Exists(strFilePath))//读取时先要判读INI文件是否存在
            {
                ...
                TextBox_KeepPressure_1.Text = ContentValue(strSec, "KeepPressure_No1_Bench2");
                TextBox_KeepTime_1.Text = ContentValue(strSec, "KeepTime_No1_Bench2");
                string ButtonState = ContentValue(strSec, "KeepSelect_No1_Bench2");
                if (ButtonState == "OFF")
                {
                ...
                TextBox_KeepPressure_2.Text = ContentValue(strSec, "KeepPressure_No2_Bench2");
                TextBox_KeepTime_2.Text = ContentValue(strSec, "KeepTime_No2_Bench2");
                ButtonState = ContentValue(strSec, "KeepSelect_No2_Bench2");
                if (ButtonState == "OFF")
                {
                ...
                TextBox_KeepPressure_3.Text = ContentValue(strSec, "KeepPressure_No3_Bench2");
                TextBox_KeepTime_3.Text = ContentValue(strSec, "KeepTime_No3_Bench2");
                ButtonState = ContentValue(strSec, "KeepSelect_No3_Bench2");
                if (ButtonState == "OFF")
                {
                ...
                TextBox_Text_No.Text = ContentValue(strSec, "TestNo_Bench2");
        ...
        private void Button_SavePara_Click(object sender, EventArgs e)
        {
            ...
            if (KeepSelect1 == "OFF")
            {
                bool bSelect1 = false;
                bSelect1 = false;
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ChanelSelect_No1_Bench2", bSelect1);
                if (code != 1)
                {
            ...
            {
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepPressure_No1_Bench2", Press1);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
                ...
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepTime_No1_Bench2", Time1);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
            ...
            if (KeepSelect2 == "OFF")
            {
                bool bSelect2 = false;
                bSelect2 = false;
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ChanelSelect_No2_Bench2", bSelect2);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
            ...
            {
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepPressure_No2_Bench2", Press2);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
                ...
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepTime_No2_Bench2", Time2);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
            ...
            if (KeepSelect3 == "OFF")
            {
                bool bSelect3 = false;
                bSelect3 = false;
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ChanelSelect_No3_Bench2", bSelect3);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
            ...
            {
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepPressure_No3_Bench2", Press3);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
                ...
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepTime_No3_Bench2", Time3);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
            ...
            WritePrivateProfileString(strSec, "KeepSelect_No1_Bench2", KeepSelect1, strFilePath);
            ...
            WritePrivateProfileString(strSec, "KeepSelect_No2_Bench2", KeepSelect2, strFilePath);
            ...
            WritePrivateProfileString(strSec, "KeepSelect_No3_Bench2", KeepSelect3, strFilePath);

            WritePrivateProfileString(strSec, "TestNo_Bench2", TextBox_Text_No.Text, strFilePath);
            //如果设置新的实验标号，则清除内存
        ...
        {
            m_BaseSettingHandle = new BaseSetting_No2(m_MainFrameHandle, this);
