...
{
    public partial class Bench_4 : Form
    {
        #region INI
        [DllImport("kernel32")]
        ...
        private TestResultShow_No4 m_TestResultHandle;
        private CreateTestResult_No4 m_CreateTestResult_No4Handle;
        ...
        public Bench_4(Form1 Handle, GroupBox grp)
        {
            InitializeComponent();
            Bench_4.CheckForIllegalCrossThreadCalls = false;
        ...
        public string m_DataBaseFilePath = Application.StartupPath + "\\4#\\DataBase.mdb";
        ...
        private void Bench_4_Load(object sender, EventArgs e)
        {
            m_SettingFormHandle = new SettingForm_No4(m_MainFrameHandle, this);
            ...
            m_TestNo = ContentValue(strSec, "TestNo_Bench4");
        ...
        private void SampleDataFun(object o, ElapsedEventArgs e)
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("PressureTest_Bench4", ref TestData, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressureTime_Bench4", ref KeepPressureTime, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("DropPressure_Bench4", ref DropPressure, ref dt);
            if (code != 1)
            {
                return;
            }
        ...
        private void SampleSystemStatusFun(object o, ElapsedEventArgs e)
        {
            ...
            DateTime dt = DateTime.Now;
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusManual_No1_Bench4", ref SystemStatusManual, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusEmergencyStop_No1_Bench4", ref SystemStatusEmergencyStop, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusStop_No1_Bench4", ref SystemStatusStop, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusAddPressure_No1_Bench4", ref SystemStatusAddPressure, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusKeepPressure_No1_Bench4", ref SystemStatusKeepPressure, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = DateTime.Now;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SystemStatusDropPressure_No1_Bench4", ref SystemStatusDropPressure, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("PressureTest_Bench4", ref PressureTest, ref dt);
            if (code != 1)
            {
                return;
            }
        ...
        private void SampleStartFun(object o, ElapsedEventArgs e)
        {
            ...
            DateTime dt = DateTime.Now;
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("ReadStartTest_Bench4", ref startFlag, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            startFlag = false;
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ReadStartTest_Bench4", startFlag);
        }
        ...
        private void SampleStopFun(object o, ElapsedEventArgs e)
        {
            ...
            bool stopFlag = false;
            DateTime dt = DateTime.Now;
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("ReadStopTest_Bench4", ref stopFlag, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ReadStopTest_Bench4", stopFlag1);
        ...
        private void BT_Start_Click(object sender, EventArgs e)
        {
            ...
            m_SampleDataTimer.Start();
            int code = m_MainFrameHandle.m_PLCCommHandle.WriteData("StartTest_Bench4", StartSignal);
            if (code != 1)
            {
        ...
        private void BT_Stop_Click(object sender, EventArgs e)
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.WriteData("StopTest_Bench4", StopSignal);
            if (code != 1)
            {
        ...
        public void CreatResultForm()
        {
            ...
            m_TestResultHandle = new TestResultShow_No4(this, m_MainFrameHandle);
        ...
        {
            m_CreateTestResult_No4Handle = new CreateTestResult_No4(this);
            m_CreateTestResult_No4Handle.ShowDialog();

            m_CreateTestResult_No4Handle.Close();
            m_CreateTestResult_No4Handle.Dispose();
        }
        ...
        private void ReadSettingData()
        {
            ...
            m_MainFrameHandle.m_PLCCommHandle.ReadData("ChanelSelect_No1_Bench4", ref ChanelSelect_No1, ref dt);

            bool ChanelSelect_No2 = false;
            m_MainFrameHandle.m_PLCCommHandle.ReadData("ChanelSelect_No2_Bench4", ref ChanelSelect_No2, ref dt);

            bool ChanelSelect_No3 = false;
            m_MainFrameHandle.m_PLCCommHandle.ReadData("ChanelSelect_No3_Bench4", ref ChanelSelect_No3, ref dt);

            float ContinueTime = 0.0f;
            if (ChanelSelect_No3)
            {
                float time3 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No3_Bench4", ref time3, ref dt);
                ContinueTime += time3;

                float Press3 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No3_Bench4", ref Press3, ref dt);

                WritePrivateProfileString(strSec, "KeepPressure_No3_Bench4", Press3.ToString(), strFilePath);
                WritePrivateProfileString(strSec, "KeepTime_No3_Bench4", time3.ToString(), strFilePath);
                WritePrivateProfileString(strSec, "KeepSelect_No3_Bench4", "ON", strFilePath);
            }

            if (ChanelSelect_No2)
            {
                float time2 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No2_Bench4", ref time2, ref dt);
                ContinueTime += time2;

                float Press2 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No2_Bench4", ref Press2, ref dt);

                WritePrivateProfileString(strSec, "KeepPressure_No2_Bench4", Press2.ToString(), strFilePath);
                WritePrivateProfileString(strSec, "KeepTime_No2_Bench4", time2.ToString(), strFilePath);
                WritePrivateProfileString(strSec, "KeepSelect_No2_Bench4", "ON", strFilePath);
            }

            if (ChanelSelect_No1)
            {
                float time1 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No1_Bench4", ref time1, ref dt);
                ContinueTime += time1;

                float Press1 = 0;
                m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepPressure_No1_Bench4", ref Press1, ref dt);

                WritePrivateProfileString(strSec, "KeepPressure_No1_Bench4", Press1.ToString(), strFilePath);
                WritePrivateProfileString(strSec, "KeepTime_No1_Bench4", time1.ToString(), strFilePath);
                WritePrivateProfileString(strSec, "KeepSelect_No1_Bench4", "ON", strFilePath);
            }
