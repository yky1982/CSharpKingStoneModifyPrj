...
namespace KingStoneModify
{
    public partial class Bench_2 : Form
    {
        ...
        private CreateTestResult_No2 m_CreateTestResult_No2Handle;
        ...
        {
            InitializeComponent();
            Bench_2.CheckForIllegalCrossThreadCalls = false;
        ...
        public string m_DataBaseFilePath = Application.StartupPath + "\\2#\\DataBase.mdb";
        ...
        private void Bench_2_Load(object sender, EventArgs e)
        {
            ...
            m_TestNo = ContentValue(strSec, "TestNo_Bench2");
        ...
        private void SampleDataFun(object o, ElapsedEventArgs e)
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("PressureTest_Bench2", ref TestData, ref dt);
            if (code != 1)
            {
                return;
            }
        ...
        {
            m_CreateTestResult_No2Handle = new CreateTestResult_No2(this);
            m_CreateTestResult_No2Handle.ShowDialog();

            m_CreateTestResult_No2Handle.Close();
            m_CreateTestResult_No2Handle.Dispose();
        }
