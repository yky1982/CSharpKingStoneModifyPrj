...
{
    public partial class CreateTestResult_No3 : Form
    {
        [DllImport("kernel32")]
        ...
        public CreateTestResult_No3(Bench_3 handle)
        {
            InitializeComponent();
        ...
        private void CreateTestResult_No3_Load(object sender, EventArgs e)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private string m_BaseFilePath = System.Windows.Forms.Application.StartupPath + "\\3#";
        ...
        //读取历史数据
        private SelectHistoryData_No3 m_SelectHistoryData_No3Handle;
        ...
        {
            this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
            m_SelectHistoryData_No3Handle = new SelectHistoryData_No3(this, m_BenchHandle);
            m_SelectHistoryData_No3Handle.ControlBox = false;
            m_SelectHistoryData_No3Handle.ShowDialog();
        ...
        //读取试验信息
        private string strFilePath = System.Windows.Forms.Application.StartupPath + @"\3#\TestInfoConfig.ini";//获取INI文件路径
        /// <summary>
        /// 读取测试信息，如测试人员--公共
        /// </summary>
