...
{
    public partial class CreateTestResult_No4 : Form
    {
        [DllImport("kernel32")]
        ...
        public CreateTestResult_No4(Bench_4 handle)
        {
            InitializeComponent();
        ...
        private void CreateTestResult_No4_Load(object sender, EventArgs e)
        {
        ...
        /// </summary>
        /// <returns></returns>
        private string m_BaseFilePath = System.Windows.Forms.Application.StartupPath + "\\4#";
        ...
        //读取历史数据
        private SelectHistoryData_No4 m_SelectHistoryData_No4Handle;
        ...
        {
            this.Cursor = System.Windows.Forms.Cursors.WaitCursor;
            m_SelectHistoryData_No4Handle = new SelectHistoryData_No4(this, m_BenchHandle);
            m_SelectHistoryData_No4Handle.ControlBox = false;
            m_SelectHistoryData_No4Handle.ShowDialog();
        ...
        //读取试验信息
        private string strFilePath = System.Windows.Forms.Application.StartupPath + @"\4#\TestInfoConfig.ini";//获取INI文件路径
        /// <summary>
        /// 读取测试信息，如测试人员--公共
        /// </summary>
        ...
        private void ReadTestDate()
        {
            ...
            dataGridView_DateList.Rows[0].Cells[0].Value = "级数/段数";
            dataGridView_DateList.Rows[0].Cells[1].Value = "初始压力（MPa）";
            dataGridView_DateList.Rows[0].Cells[2].Value = "终止压力（MPa）";
            dataGridView_DateList.Rows[0].Cells[3].Value = "保压时间（Min）";
            dataGridView_DateList.Rows[0].Cells[4].Value = "保压压降（MPa）";
        ...
        private bool ReadCurveDataFromDataBase_e()
        {
            ...
            //int second = (int)tp.TotalSeconds;
            //label_X1_e.Text = startTime.ToString("HH:mm:ss");
            ////label_X4_e.Text = tp.ToString("HH:mm:ss");
        ...
        public void ReadTestPic()
        {
            ...
            m_BenchHandle.m_DrawCurveHandle.DrawLine(f, panel_Result, Color.Red, p[len - 1].X + 10, 250f);
        }
