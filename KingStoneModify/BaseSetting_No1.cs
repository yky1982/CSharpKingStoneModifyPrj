...
namespace KingStoneModify
{
    public partial class BaseSetting_No1 : Form
    {
        ...
        private bool SetPara()
        {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("SensorLength_Bench1", SensorLength);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("SensorOffSet_Bench1", SensorOffSet);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepPressStabilityTime_Bench1", StabilityTime);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("OpenValveTime_Bench1", OpenValveTime);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("DropPressSelect_Bench1", DropPressSelect);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("TestPressInterval_Bench1", TestPressInterval);
            if (code != 1)
            {
        ...
        {
            TB_HighBumpStartPress.Text = ContentValue(strSec, "HighBumpStartPress_Bench1");
            TB_SensorLength.Text = ContentValue(strSec, "SensorLength_Bench1");
            TB_SensorOffset.Text = ContentValue(strSec, "SensorOffSet_Bench1");
            TB_StabilityTime.Text = ContentValue(strSec, "KeepPressStabilityTime_Bench1");
            TB_OpenValveTime.Text = ContentValue(strSec, "OpenValveTime_Bench1");
            TB_DropPressSelect.Text = ContentValue(strSec, "DropPressSelect_Bench1");
            TB_TestPressIntervalTime.Text = ContentValue(strSec, "TestPressInterval_Bench1");
        }
