...
{
    public partial class BaseSetting_No2 : Form
    {
        [DllImport("kernel32")]
        ...
        public BaseSetting_No2(Form1 Handle, SettingForm_No2 handle)
        {
            InitializeComponent();
        ...
        private void BaseSetting_No2_Load(object sender, EventArgs e)
        {
        ...
        private bool SetPara()
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.WriteData("HighBumpStartPress_Bench2", HighBumpStartPress);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("SensorLength_Bench2", SensorLength);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("SensorOffSet_Bench2", SensorOffSet);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepPressStabilityTime_Bench2", StabilityTime);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("OpenValveTime_Bench2", OpenValveTime);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("DropPressSelect_Bench2", DropPressSelect);
            if (code != 1)
            {
            ...
            code = m_MainFrameHandle.m_PLCCommHandle.WriteData("TestPressInterval_Bench2", TestPressInterval);
            if (code != 1)
            {
            ...
            WritePrivateProfileString(strSec, "HighBumpStartPress_Bench2", HighBumpStartPress.ToString("0.00"), strFilePath);
            WritePrivateProfileString(strSec, "SensorLength_Bench2", SensorLength.ToString("0.00"), strFilePath);
            WritePrivateProfileString(strSec, "SensorOffSet_Bench2", SensorOffSet.ToString("0.00"), strFilePath);
            WritePrivateProfileString(strSec, "KeepPressStabilityTime_Bench2", StabilityTime.ToString(), strFilePath);
            WritePrivateProfileString(strSec, "OpenValveTime_Bench2", OpenValveTime.ToString(), strFilePath);
            WritePrivateProfileString(strSec, "DropPressSelect_Bench2", DropPressSelect.ToString("0.00"), strFilePath);
            WritePrivateProfileString(strSec, "TestPressInterval_Bench2", TestPressInterval.ToString(), strFilePath);
            return true;
        }
        ...
        private string strFilePath = Application.StartupPath + @"\2#\BaseSettingConfig.ini";//获取INI文件路径
        private string strSec = "BaseSettingConfig"; //INI文件名
        private void ReadDataFromIni()
        {
            TB_HighBumpStartPress.Text = ContentValue(strSec, "HighBumpStartPress_Bench2");
            TB_SensorLength.Text = ContentValue(strSec, "SensorLength_Bench2");
            TB_SensorOffset.Text = ContentValue(strSec, "SensorOffSet_Bench2");
            TB_StabilityTime.Text = ContentValue(strSec, "KeepPressStabilityTime_Bench2");
            TB_OpenValveTime.Text = ContentValue(strSec, "OpenValveTime_Bench2");
            TB_DropPressSelect.Text = ContentValue(strSec, "DropPressSelect_Bench2");
            TB_TestPressIntervalTime.Text = ContentValue(strSec, "TestPressInterval_Bench2");
        }
