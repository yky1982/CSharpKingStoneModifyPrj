...
{
    public partial class TestResultShow_No1 : Form
    {
        [DllImport("kernel32")]
        ...
        public TestResultShow_No1(Bench_1 Handle, Form1 MainHandle)
        {
            InitializeComponent();
        ...
        private void TestResultShow_No1_Load(object sender, EventArgs e)
        {
            ...
            textBox_TestNo.Text = ContentValue(strSec, "TestNo_Bench1");
        ...
        private void SampleDateFun(object o, ElapsedEventArgs e)
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("InitPressure_No1_Bench1", ref InitPressure_No1, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("InitPressure_No2_Bench1", ref InitPressure_No2, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("InitPressure_No3_Bench1", ref InitPressure_No3, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("EndPressure_No1_Bench1", ref EndPressure_No1, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("EndPressure_No2_Bench1", ref EndPressure_No2, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("EndPressure_No3_Bench1", ref EndPressure_No3, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("DropPressure_No1_Bench1", ref DropPressure_No1, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("DropPressure_No2_Bench1", ref DropPressure_No2, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("DropPressure_No3_Bench1", ref DropPressure_No3, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No1_Bench1", ref KeepPressureTime_No1, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No2_Bench1", ref KeepPressureTime_No2, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("KeepTime_No3_Bench1", ref KeepPressureTime_No3, ref dt);
            if (code != 1)
            {
                return;
            }
            ...
            dt = default(DateTime);
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("TestTimes_No1_Bench1", ref TestTimes, ref dt);
            if (code != 1)
            {
                return;
            }
        ...
        private void SampleSaveFun(object o, ElapsedEventArgs e)
        {
            ...
            int code = m_MainFrameHandle.m_PLCCommHandle.ReadData("ReadSaveFlag_Bench1", ref saveFlag, ref dt);
            ...
            if (saveFlag)
            {
                ...
                SavePara();
                saveFlag = false;
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ReadSaveFlag_Bench1", saveFlag);
                m_BenchHandle.Show();
                this.Hide();
                //this.Dispose();
            }
            bool CancelSaveFlag = false;
            code = m_MainFrameHandle.m_PLCCommHandle.ReadData("SaveFlag_Bench1", ref CancelSaveFlag, ref dt);
            if (CancelSaveFlag)
            {
                m_SampleDateTimer.Stop();
                m_SampleSaveTimer.Stop();
                ...
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("SaveFlag_Bench1", CancelSaveFlag);
                m_BenchHandle.Show();
                this.Hide();
                //this.Dispose();
            }
        ...
        private void SavePara()
        {
            ...
            if (testNo == m_BenchHandle.m_TestNo)
            {
                ...
                if (m_TestTimes >= 1)
                {
                    ...
                    m_BenchHandle.m_TestResultLists.Add(new Bench_1.TestResultList(No, m_InitPressure_No1, m_EndPressure_No1, m_KeepPressureTime_No1, m_DropPressure_No1));
                }
                if (m_TestTimes >= 2)
                {
                    string No = m_BenchHandle.m_TestSequence.ToString() + "--2";
                    m_BenchHandle.m_TestResultLists.Add(new Bench_1.TestResultList(No, m_InitPressure_No2, m_EndPressure_No2, m_KeepPressureTime_No2, m_DropPressure_No2));
                }
                if (m_TestTimes >= 3)
                {
                    string No = m_BenchHandle.m_TestSequence.ToString() + "--3";
                    m_BenchHandle.m_TestResultLists.Add(new Bench_1.TestResultList(No, m_InitPressure_No3, m_EndPressure_No3, m_KeepPressureTime_No3, m_DropPressure_No3));
                }
                if (m_TestTimes >= 4)
                {
                    //不存在
