...
{
    public partial class SelectHistoryData_No3 : Form
    {
        private CreateTestResult_No3 m_ParentHandle;
        private Bench_3 m_BenchHandle;
        public SelectHistoryData_No3(CreateTestResult_No3 handle, Bench_3 benchHandle)
        {
            InitializeComponent();
        ...
        private void SelectHistoryData_No3_Load(object sender, EventArgs e)
        {
