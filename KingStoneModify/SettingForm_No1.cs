    ...
    public partial class SettingForm_No1 : Form
    {
        ...
        private void Button_SavePara_Click(object sender, EventArgs e)
        {
            ...
            if (KeepSelect1 == "OFF")
            {
                bool bSelect1 = false;
                bSelect1 = false;
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("ChanelSelect_No1_Bench1", bSelect1);
                if (code != 1)
                {
            ...
            {
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepPressure_No1_Bench1", Press1);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
                ...
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepTime_No1_Bench1", Time1);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
            ...
            {
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepPressure_No2_Bench1", Press2);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
                ...
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepTime_No2_Bench1", Time2);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
            ...
            {
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepPressure_No3_Bench1", Press3);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
                ...
                code = m_MainFrameHandle.m_PLCCommHandle.WriteData("KeepTime_No3_Bench1", Time3);
                if (code != 1)
                {
                    //m_MainFrameHandle.m_LogWR.WriteLog(m_LogFilePath, "SetParamentForm");
            ...
            WritePrivateProfileString(strSec, "KeepSelect_No1_Bench1", KeepSelect1, strFilePath);
            ...
            WritePrivateProfileString(strSec, "KeepSelect_No2_Bench1", KeepSelect2, strFilePath);
            ...
            WritePrivateProfileString(strSec, "KeepSelect_No3_Bench1", KeepSelect3, strFilePath);
